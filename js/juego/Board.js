...
class Board{
    ...
    //Se crea el tablero
    constructor(context, current_mode, player1, player2) {
    ...
    drawBoard() {
        ...
        // Ajusta el tamaño del tablero según el modo de juego seleccionado
       // let boardWidth = modes[current_mode].columns * 100;
       // let boardHeight = modes[current_mode].rows * 65;
        //let boardX = (1100 - boardWidth) / 2;  // Centra el tablero en el canvas
        //let boardY = 95 + (460 - boardHeight);  // Ajusta la posición vertical
